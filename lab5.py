...
# Initiate BRISK/KAZE detector
# your code #
akaze = cv2.AKAZE_create()

# Find the keypoints and descriptors with BRISK/KAZE
# your code #
kp1, des1 = akaze.detectAndCompute(img2, None)
kp2, des2 = akaze.detectAndCompute(img1, None)
